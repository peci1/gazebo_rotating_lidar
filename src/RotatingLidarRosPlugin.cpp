...
#include <gazebo_rotating_lidar/RotatingLidarRosPlugin.h>

namespace gazebo
{
// Register this plugin with the simulator
GZ_REGISTER_SENSOR_PLUGIN(GazeboRosRotatingLaser)

////////////////////////////////////////////////////////////////////////////////
// Constructor
GazeboRosRotatingLaser::GazeboRosRotatingLaser()
{
  this->seed = 0;
}
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosRotatingLaser::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
  // load plugin
  ...
  this->parent_ray_sensor_ =
      dynamic_pointer_cast<sensors::RotatingLidarSensor>(_parent);

  if (!this->parent_ray_sensor_)
  gzthrow("GazeboRosRotatingLaser controller requires a Ray Sensor as its parent");
  ...
  this->deferred_load_thread_ = boost::thread(
      boost::bind(&GazeboRosRotatingLaser::LoadThread, this));

}

////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosRotatingLaser::LoadThread()
{
  ...
  if (this->topic_name_ != "")
  {
    ros::AdvertiseOptions ao =
        ros::AdvertiseOptions::create<sensor_msgs::LaserScan>(
            this->topic_name_, 1,
            boost::bind(&GazeboRosRotatingLaser::LaserConnect, this),
            boost::bind(&GazeboRosRotatingLaser::LaserDisconnect, this),
            ros::VoidPtr(), NULL);
...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void GazeboRosRotatingLaser::LaserConnect()
{
  this->laser_connect_count_++;
  if (this->laser_connect_count_ == 1)
    this->laser_scan_sub_ =
        this->gazebo_node_->Subscribe(this->parent_ray_sensor_->Topic(),
                                      &GazeboRosRotatingLaser::OnScan, this);
}

////////////////////////////////////////////////////////////////////////////////
// Decrement count
void GazeboRosRotatingLaser::LaserDisconnect()
{
  this->laser_connect_count_--;
...
void GazeboRosRotatingLaser::OnScan(ConstLaserScanStampedPtr &_msg)
{
  ...
  laser_msg.time_increment = this->parent_ray_sensor_->TimeIncrement().Float();
  laser_msg.scan_time = this->parent_ray_sensor_->ScanTime().Float();
