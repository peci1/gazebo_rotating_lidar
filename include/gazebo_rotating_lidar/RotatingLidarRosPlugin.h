...
#ifndef GAZEBO_ROTATING_LIDAR_ROTATINGLIDARROSPLUGIN_H
#define GAZEBO_ROTATING_LIDAR_ROTATINGLIDARROSPLUGIN_H
...
namespace gazebo
{
class GazeboRosRotatingLaser : public RayPlugin
{
  /// \brief Constructor
  public: GazeboRosRotatingLaser();
  ...
  private: std::shared_ptr<sensors::RotatingLidarSensor> parent_ray_sensor_;
...
#endif //GAZEBO_ROTATING_LIDAR_ROTATINGLIDARROSPLUGIN_H